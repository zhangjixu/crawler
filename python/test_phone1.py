    ...
    if title is None:
        ...
        for answer_item in answer_items:
            try:
                ...
                # user_answer = answer_item.find('div', {'class': 'answer-text-full rich-text'}).find('p').string
        ...
        print org, release_date
        print soup.find('div', {'class': 'article-content'}).get_text()
...
if __name__ == '__main__':
    # main()
    parse_html('https://www.toutiao.com/a6584251734229516558/?iid=39114877791&app=news_article&is_hit_share_recommend=1')
